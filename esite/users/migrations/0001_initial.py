    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.BooleanField(null=True)),
                ...
                ('personalisation', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('newsletter', models.BooleanField(null=True)),
                ('gdpr', models.BooleanField(null=True)),
                ('balance', models.IntegerField(null=True)),
                ('loyalty', models.IntegerField(null=True)),
                ('achievements', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('rememberToken', models.CharField(max_length=512, null=True)),
        ...
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ('invoiceName', models.CharField(max_length=12, primary_key=True, serialize=False)),
                ('invoiceCashback', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('invoicePaymentTime', models.IntegerField(null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Item',
