...
ENV UWSGI_VIRTUALENV=/venv UWSGI_WSGI_FILE=esite/wsgi_production.py UWSGI_HTTP=:8000 UWSGI_MASTER=1 UWSGI_WORKERS=2 UWSGI_THREADS=1 UWSGI_UID=1000 UWSGI_GID=2000
